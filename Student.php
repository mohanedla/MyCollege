 ...
 mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);  
   if(isset($_POST['menu_ar_add'])){
    ...
    $sql = " select * from student where email = '$email' or student_id = '$username' ";
        ...
        if($rows == 1){
          ?>
    <div class="modal fade" id="validate_email" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">
                        <h3>لديك حساب أو اسم مستخدم مسجل بالفعل </h3>
                    </h5>
...
if(isset($_POST['menu_ar_edit'])){
  ...
  try {
    ...
    ?>
    <div class="modal fade" id="check_result" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">
                        <h3>الرجاء ادخال الدرجة بشكل صحيح</h3>
                    </h5>
                    <button type="button" class="close" onclick="goBack()" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    <form class="contact-form " action="?result_edit=<?php echo $course_id ?>" method="post" id=""
...
?>
    <div class="modal fade" id="grad_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="contact-form " action="Student.php" method="post" id="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <input type="hidden" class="form-control" required name="user_name"
                                value="<?php echo ''.$user['student_id'].'' ?>">
                        </div>
  ...
  if(isset($_GET['user_Course'])){
    ...
    <div class="modal fade" id="select" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="bt_pos">
        <form action="Student.php" method="get">
            ...
            <button style="float:right; background:#ffffff;border-color:#007bff; margin-right:50px" type="submit"
                name="menu_ar_edit" class="btn btn-success"><a href="?user_add="
                    style="color:black;text-decoration: none;">إضافة طالب</a></button>
        </form>
